...
typedef struct
{
	uint16_t            EXTI_Input_LineNumbers ;
...
typedef struct
{
	EXTI_GPIO_Mapping_t EXTI_PIN ;      //Specifies  The External Interrupt  GPIO Mapping
	                                    // This Parameters Must Be Set Based @ref EXTI_define

	uint8_t trigger_Case ;                  //Specifies The Rising and The Falling and both Trigger
                                        // This Parameters Must Be Set Based @ref EXTI_TRIGGER_define

	uint8_t IRQ_EN       ;                  //Enable or Disable the EXTI_IRQ (That Will Enable The IRQ MASK in EXTI and Also on the NVIC Interrupt Controller)
                                           // This Parameters Must Be Set Based @ref EXTI_IRQ_define
