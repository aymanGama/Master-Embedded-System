...
void MCAL_UART_Init (USART_Typedef *USARTx, UART_Config* UART_Config)
{
	...
	if (UART_Config->IRQ_Enable  != UART_IRQ_Enable_NONE)
	{
		...
		if ( USARTx == USART1 )
		{
			...
			PT_ISR[0] = UART_Config->P_IRQ_CallBack ;
		}
		...
		else if ( USARTx == USART2 )
		{
			...
			PT_ISR[1] = UART_Config->P_IRQ_CallBack ;
		}
		...
		else if ( USARTx == USART3 )
		{
			...
			PT_ISR[2] = UART_Config->P_IRQ_CallBack ;
		}
...
void MCAL_UART_GPIO_Set_Pins (USART_Typedef *USARTx)
{
	...
	if ( USARTx == USART1 )
	{
		...
		//PA9 TX
		PinCfg.GPIO_PIN_Numbers = GPIO_PIN_9;
		PinCfg.GPIO_PIN_MODE = PIN_MODE_OUT_AFPP;
		PinCfg.GPIO_OUTPIN_Speed = PIN_OUT_SPEED_10;
		MCAL_GPIO_INIT(GPIOA, &PinCfg);

		//PA10 RX
		PinCfg.GPIO_PIN_Numbers = GPIO_PIN_10;
		PinCfg.GPIO_PIN_MODE = PIN_MODE_IN_AF;
		MCAL_GPIO_INIT(GPIOA, &PinCfg);

		if (Global_UART_Config->HwFlowCtl  ==UART_HwFlowCtl_CTS  || Global_UART_Config->HwFlowCtl  ==UART_HwFlowCtl_RTS_CTS  ){
			//PA11 CTS
			PinCfg.GPIO_PIN_Numbers = GPIO_PIN_11;
			PinCfg.GPIO_PIN_MODE = PIN_MODE_IN_FI;
			MCAL_GPIO_INIT(GPIOA, &PinCfg);
		}
		...
		{
			//PA12 RTS
			PinCfg.GPIO_PIN_Numbers = GPIO_PIN_12;
			PinCfg.GPIO_PIN_MODE = PIN_MODE_OUT_AFPP;
			PinCfg.GPIO_OUTPIN_Speed = PIN_OUT_SPEED_10;
			MCAL_GPIO_INIT(GPIOA, &PinCfg);
	...
	else if ( USARTx == USART2 )
	{
		...
		//PA2 TX
		PinCfg.GPIO_PIN_Numbers = GPIO_PIN_2;
		PinCfg.GPIO_PIN_MODE = PIN_MODE_OUT_AFPP;
		PinCfg.GPIO_OUTPIN_Speed = PIN_OUT_SPEED_10;
		MCAL_GPIO_INIT(GPIOA, &PinCfg);

		//PA3 RX
		PinCfg.GPIO_PIN_Numbers = GPIO_PIN_3;
		PinCfg.GPIO_PIN_MODE = PIN_MODE_IN_AF;
		MCAL_GPIO_INIT(GPIOA, &PinCfg);
		...
		{
			//PA0 CTS
			PinCfg.GPIO_PIN_Numbers = GPIO_PIN_0;
			PinCfg.GPIO_PIN_MODE = PIN_MODE_IN_FI;
			MCAL_GPIO_INIT(GPIOA, &PinCfg);
		}
		...
		{
			//PA1 RTS
			PinCfg.GPIO_PIN_Numbers = GPIO_PIN_1;
			PinCfg.GPIO_PIN_MODE = PIN_MODE_OUT_AFPP;
			PinCfg.GPIO_OUTPIN_Speed = PIN_OUT_SPEED_10;
			MCAL_GPIO_INIT(GPIOA, &PinCfg);
		}
	...
	else if ( USARTx == USART3 )
	{
		...
		{
			//PB13 CTS
			PinCfg.GPIO_PIN_Numbers = GPIO_PIN_13;
			PinCfg.GPIO_PIN_MODE = PIN_MODE_IN_FI;
			MCAL_GPIO_INIT(GPIOB, &PinCfg);
		}
		if (Global_UART_Config->HwFlowCtl  ==UART_HwFlowCtl_RTS || Global_UART_Config->HwFlowCtl  ==UART_HwFlowCtl_RTS_CTS  )
		{
			//PA14 RTS
			PinCfg.GPIO_PIN_Numbers = GPIO_PIN_14;
			PinCfg.GPIO_PIN_MODE = PIN_MODE_OUT_AFPP;
			PinCfg.GPIO_OUTPIN_Speed = PIN_OUT_SPEED_10;
			MCAL_GPIO_INIT(GPIOB, &PinCfg);
